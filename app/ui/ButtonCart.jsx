...
export function ButtonCart({ buttonText, buttonHref }) {
  return (
    <Link
      href={buttonHref}
      className="flex max-w-[272px] justify-center bg-[#3F418D] py-2 text-white hover:bg-white border hover:border-[#3F418D] hover:text-[#3F418D]"
    >
      <div className="flex items-center">
        <Image
          src={"/icons/iconsCart.svg"}
          height={40}
          width={40}
          alt="Cart"
